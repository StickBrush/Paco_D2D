...
public class LocationService extends Service implements
    ...
    private Initializer initializer = vehicularDefaults();//
    ...
    private List<LSTFilter> getInitializedFilters(){
        ...
        LSTFilter filterMain = new LSTFilter(rtree, initializer);
        ...
        LSTFilter filterMid = new LSTFilter(rtreeMid, initializer);
        ...
        LSTFilter filterSparse = new LSTFilter(rtreeSparse, initializer);
